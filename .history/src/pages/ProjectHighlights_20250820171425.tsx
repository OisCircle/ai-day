...
const ProjectHighlights = () => {
  const [activeHighlight, setActiveHighlight] = useState<string>("ai-questions");
  ...
  const highlights: ProjectHighlight[] = [
    {
      ...
      title: "AI千人千面面试题生成",
      subtitle: "智能个性化面试体验",
      description: "基于深度学习算法，为每位候选人生成个性化面试题目，深度挖掘候选人潜力，提供更加精准的人才评估",
      features: [
        "AI智能分析候选人简历背景",
        "根据岗位要求动态生成面试题",
        "支持多维度能力考察",
    ...
    },
    {
      ...
      description: "自动记录面试全过程，智能生成面试摘要和关键信息提取，帮助面试官避免记录混乱，提升面试质量",
      features: [
        "实时语音转文字记录",
        "智能关键信息提取",
        "自动生成面试摘要",
    ...
    },
    {
      ...
      description: "为每位候选人生成专属的AI分析报告，包含能力评估、发展建议和匹配度分析，助力精准人才决策",
      features: [
        "多维度能力雷达图分析",
        "个性特征深度画像",
        "岗位匹配度智能评分",
    ...
    },
    {
      ...
      description: "通过AI分析面试官表现，提供个性化的面试技巧建议和培训方案，持续提升面试质量和专业水平",
      features: [
        "面试技巧智能评估",
        "个性化改进建议",
        "面试质量趋势分析",
  ...
  const currentHighlight = highlights.find(h => h.id === activeHighlight) || highlights[0];
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
              {[
                ...
                return (
                  <div key={index} className="backdrop-blur-sm bg-white bg-opacity-20 rounded-xl p-6 transform hover:scale-105 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {highlights.map((highlight, index) => {
            ...
            return (
              <div
                ...
                style={{
                  background: isActive 
                    ? `linear-gradient(135deg, ${highlight.gradient.split(' ')[1]}, ${highlight.gradient.split(' ')[3]})` 
                    : 'white'
                }}
              >
                {/* 背景装饰 */}
                <div className={`absolute inset-0 bg-gradient-to-br ${highlight.gradient} opacity-${isActive ? '100' : '10'} transition-opacity duration-300`}></div>
                ...
                <div className="relative z-10">
                  <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg mb-4 ${
                    isActive ? 'bg-white bg-opacity-20' : 'bg-gradient-to-br ' + highlight.gradient
                  }`}>
                  ...
                  <h3 className={`font-bold text-lg mb-2 ${isActive ? 'text-white' : 'text-gray-900'}`}>
                    ...
                    {highlight.title.includes('AI') && <span className="text-yellow-300">AI</span>}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-12">
              <div className="flex items-center mb-6">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br ${currentHighlight.gradient} mr-6`}>
                ...
                <div>
                  ...
                  <p className={`text-lg bg-gradient-to-r ${currentHighlight.gradient} bg-clip-text text-transparent font-semibold`}>
              ...
              <div className="space-y-4 mb-8">
                ...
                {currentHighlight.features.map((feature, index) => (
                  ...
                  >
                    <div className={`flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r ${currentHighlight.gradient} flex items-center justify-center mt-0.5`}>
              ...
              <div className="flex space-x-4">
                <button className={`px-8 py-3 rounded-xl text-white font-semibold bg-gradient-to-r ${currentHighlight.gradient} hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center`}>
            ...
            {/* 右侧：数据统计与可视化 */}
            <div className={`bg-gradient-to-br ${currentHighlight.gradient} p-12 text-white relative overflow-hidden`}>
              {/* 背景装饰 */}
                    ...
                    >
                      ...
                      <div className="w-full bg-white bg-opacity-20 rounded-full h-2">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.min(parseFloat(stat.value.replace(/[^\d.]/g, '')), 100)}%`,
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              title: "深度学习算法",
              description: "基于最新的Transformer架构，提供精准的语义理解和智能分析",
              icon: Brain,
            ...
            return (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${tech.color} mb-6`}>
