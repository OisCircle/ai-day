          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-medium text-blue-800">综合评分</div>
                    <div className="text-2xl font-bold text-blue-600">{selectedCandidate.aiAnalysis.overallScore}/10</div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-medium text-green-800">技能匹配</div>
                    <div className="text-2xl font-bold text-green-600">{selectedCandidate.aiAnalysis.skillMatchScore}%</div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-medium text-purple-800">成功预测</div>
                    <div className="text-2xl font-bold text-purple-600">{selectedCandidate.aiAnalysis.predictedSuccess}%</div>
                  </div>
                  <Zap className="h-8 w-8 text-purple-500" />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-medium text-yellow-800">成长潜力</div>
                    <div className="text-2xl font-bold text-yellow-600">{selectedCandidate.aiAnalysis.growthPotential}%</div>
                  </div>
              ...
              <div className="lg:col-span-1">
                <div className="space-y-4">
                  ...
                  <div className="card p-4">
                    ...
                    <div className="space-y-2">
                      {selectedCandidate.aiAnalysis.recommendations.map((recommendation, index) => (
                        <div key={index} className="flex items-center text-sm text-blue-700 bg-blue-50 p-2 rounded">
