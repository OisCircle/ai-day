                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            {/* 会议记录按钮 */}
                            <button
                              onClick={() => selectedCandidate && handleViewMeetingRecord(selectedCandidate.id, report.interviewType)}
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                <span className="ml-auto text-sm bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-3 py-1 rounded-full">
                  4轮面试完成
                              ...
                              {generateMockReport(selectedCandidate).map((report, reportIndex) => (
                <div key={report.id} className="mb-8 relative">
                  {/* 时间线连接线 */}
                  {reportIndex < generateMockReport(selectedCandidate).length - 1 && (
                  ...
                  <div className="card p-8 relative z-10 border-l-4 border-l-primary-500 bg-gradient-to-r from-gray-50 to-blue-50">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          {report.weaknesses.map((weakness, weaknessIndex) => (
                            <li
                              key={weaknessIndex}
