...
const AIInterviewQuestions: React.FC = () => {
  ...
  const [interviewRounds, setInterviewRounds] = useState<InterviewRoundQuestions[]>([]);
    ...
    const rounds: InterviewRoundQuestions[] = [
      {
        ...
        questions: [
          {
            id: "hr_1",
            question: "请介绍一下你的职业发展历程，特别是从美团到字节跳动的转换过程中，你是如何规划自己的技术成长路径的？",
            category: "职业发展",
            difficulty: "medium",
            tags: ["职业规划", "自我认知", "技术成长"],
            expectedAnswer: "应该体现清晰的职业规划思路，技术深度的追求，以及对不同公司文化的适应能力",
            followUps: [
          ...
          {
            id: "hr_2",
            question: "描述一次你在团队中解决冲突或分歧的经历，特别是在技术选型或架构设计方面产生争议时，你是如何处理的？",
            category: "团队协作",
            difficulty: "hard",
            tags: ["团队协作", "冲突解决", "沟通技巧"],
            expectedAnswer: "应展现出成熟的沟通技巧、换位思考能力和寻求双赢解决方案的思维",
            followUps: [
          ...
          {
            id: "hr_3",
            question: "在高强度的项目开发过程中，你如何平衡代码质量和交付速度？当业务方要求快速上线而技术债务积累时，你会如何权衡？",
            category: "工作态度",
            difficulty: "hard",
            tags: ["工作压力", "决策能力", "质量意识"],
            expectedAnswer: "体现出对技术债务的深刻理解，以及在业务需求和技术质量之间寻求平衡的智慧",
            followUps: [
      ...
      },
      {
        ...
        questions: [
          {
            id: "tech1_1",
            question: "请详细阐述 Golang 的 goroutine 调度器（GMP 模型）的工作原理，以及它如何解决传统线程模型的性能问题。在你的项目中，你是如何优化 goroutine 的使用来提升系统性能的？",
            category: "Golang深度",
            difficulty: "hard",
            tags: ["GMP模型", "并发编程", "性能优化", "调度器"],
            expectedAnswer: "应深入讲解GMP模型的核心机制，包括G、M、P的作用，work stealing算法，以及具体的优化实践",
            followUps: [
          ...
          {
            id: "tech1_2",
            question: "基于你在字节跳动实施的 DDD 重构项目，请详细描述领域驱动设计的核心概念和实践。如何识别和划分领域边界？聚合根的设计原则是什么？事件溯源和 CQRS 模式在你的项目中是如何应用的？",
            category: "DDD架构",
            difficulty: "hard",
            tags: ["DDD", "聚合根", "事件溯源", "CQRS", "领域建模"],
            expectedAnswer: "应体现对DDD理论的深刻理解和丰富的实践经验，包括具体的设计决策和权衡考虑",
            followUps: [
              "如何处理跨聚合的事务一致性问题？",
          ...
          {
            id: "tech1_3",
            question: "设计一个能够支持每秒50万QPS的订单处理系统。请从数据库选型、缓存策略、消息队列、负载均衡等多个维度来阐述你的技术方案。特别说明如何保证系统的一致性、可用性和分区容错性。",
            category: "系统设计",
            difficulty: "hard",
            tags: ["高并发", "系统设计", "分布式", "CAP理论", "性能优化"],
            expectedAnswer: "需要展现出完整的系统设计思路，包括技术选型的权衡、性能瓶颈的分析和解决方案",
            followUps: [
              "如何设计分布式ID生成策略？",
              "数据库分库分表的策略和路由规则如何设计？",
              "如何实现最终一致性？补偿机制如何设计？"
          ...
          {
            id: "tech1_4",
            question: "在 Golang 中如何进行内存管理和垃圾回收优化？请结合你的项目经验，说明如何通过内存分析工具定位内存泄露问题，以及如何设计对GC友好的数据结构。",
            category: "性能调优",
            difficulty: "medium",
            tags: ["内存管理", "GC优化", "性能分析", "pprof"],
            expectedAnswer: "应涵盖Golang内存模型、GC算法、性能分析工具的使用和具体的优化实践",
            followUps: [
      ...
      },
      {
        ...
        questions: [
          {
            id: "tech2_1",
            question: "作为技术负责人，你如何制定团队的技术发展路线图？在推进 DDD 架构重构时，如何说服团队和管理层投入资源？如何评估重构的ROI？",
            category: "技术管理",
            difficulty: "hard",
            tags: ["技术规划", "团队管理", "决策能力", "ROI评估"],
            expectedAnswer: "展现技术leader的思维方式，包括战略规划、团队说服、价值量化等能力",
            followUps: [
          ...
          {
            id: "tech2_2",
            question: "在微服务架构演进过程中，你遇到过哪些挑战？如何处理服务间的依赖关系？如何设计服务的容错和降级策略？分布式追踪和监控体系是如何建设的？",
            category: "架构演进",
            difficulty: "hard",
            tags: ["微服务", "容错设计", "分布式追踪", "监控体系"],
            expectedAnswer: "体现对微服务架构的深入理解和丰富的实践经验，包括遇到的坑和解决方案",
            followUps: [
          ...
          {
            id: "tech2_3",
            question: "面对突发的生产事故（比如双十一期间系统crash），你作为技术负责人会如何应对？请描述完整的应急响应流程。如何进行事后复盘和系统改进？",
            category: "应急处理",
            difficulty: "hard",
            tags: ["应急响应", "故障处理", "团队协调", "复盘改进"],
            expectedAnswer: "展现在高压环境下的决策能力、团队协调能力和持续改进的思维",
            followUps: [
              "如何在不确定原因的情况下快速止损？",
              "事故期间如何与业务方、运营团队协调沟通？",
              "如何建立可观测性体系来提前发现潜在问题？"
          ...
          {
            id: "tech2_4",
            question: "你如何看待新技术的引入？比如 Go 的泛型、Kubernetes、Istio 等新技术，你会如何评估是否在项目中采用？有哪些决策维度？",
            category: "技术决策",
            difficulty: "medium",
            tags: ["技术选型", "创新能力", "风险评估", "技术趋势"],
            expectedAnswer: "体现对新技术的敏感度和理性的评估能力，平衡创新和稳定性",
            followUps: [
              "如何在保证系统稳定的前提下进行技术创新？",
              "团队成员对新技术接受度不高时如何推进？",
              "如何建立技术调研和预研的机制？"
      ...
      },
      {
        ...
        questions: [
          {
            id: "vp_1",
            question: "从技术角度看，你认为当前互联网行业面临哪些挑战和机遇？作为资深技术专家，你如何看待技术驱动业务创新的价值？请结合你的经验谈谈技术如何赋能业务增长。",
            category: "战略思维",
            difficulty: "hard",
            tags: ["行业洞察", "技术战略", "业务价值", "创新思维"],
            expectedAnswer: "展现对行业趋势的深刻洞察和技术价值的理解，体现战略思维和大局观",
            followUps: [
          ...
          {
            id: "vp_2",
            question: "如果让你负责一个50人的技术团队，你会如何设计组织架构和管理体系？如何建立技术文化？如何平衡团队成员的个人成长和公司业务需求？",
            category: "团队管理",
            difficulty: "hard",
            tags: ["组织管理", "团队建设", "人才培养", "文化建设"],
            expectedAnswer: "体现管理思维和人才培养理念，展现建设高效技术团队的能力",
            followUps: [
              "如何处理高绩效但难管理的技术专家？",
              "技术团队的KPI体系应该如何设计？",
              "如何让技术团队更好地理解业务价值？"
          ...
          {
            id: "vp_3",
            question: "面对快速变化的市场环境，技术团队应该如何保持敏捷性和适应性？你如何看待技术债务和快速迭代之间的平衡？在资源有限的情况下，如何做技术投入的优先级排序？",
            category: "决策能力",
            difficulty: "hard",
  ...
  const getAIRatingStars = (rating: number) => {
    ...
    return (
      <div className="flex items-center">
        ...
        {hasHalfStar && <Star className="h-4 w-4 text-yellow-400 fill-current opacity-50" />}
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedCandidate.resume.skills.technical.slice(0, 6).map((skill, index) => (
          ...
          <div className="card p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">AI 候选人画像</h3>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-green-800">技术优势</span>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-blue-800">匹配度分析</span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-orange-800">关注点</span>
                </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs opacity-75">{round.questions.length} 道题</div>
                    </div>
                  </button>
                );
              })}
          ...
          {currentRound && (
            <>
              <div className={`card p-6 border-l-4 ${
                currentRound.type === 'hr' ? 'border-blue-500' :
                currentRound.type === 'tech_1' ? 'border-green-500' :
                currentRound.type === 'tech_2' ? 'border-purple-500' : 'border-orange-500'
              }`}>
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className={`text-xl font-bold mb-2 ${currentRound.color}`}>
                      {currentRound.title}
                    </h3>
                    <p className="text-gray-600 mb-4">{currentRound.description}</p>
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium text-gray-700">评估重点：</span>
                  ...
                  <div className={`p-3 rounded-full ${currentRound.bgColor}`}>
                    <currentRound.icon className={`h-6 w-6 ${currentRound.color}`} />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {currentRound.questions.map((question, index) => (
                  <div key={question.id} className="card p-6 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-3">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-xs text-gray-500">{question.timeLimit}分钟</span>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 mb-4">
                          <h5 className="text-sm font-medium text-gray-900 mb-2">期望回答要点：</h5>
                          <p className="text-sm text-gray-600">{question.expectedAnswer}</p>
                        </div>

                        {question.followUps.length > 0 && (
                          <div className="bg-blue-50 rounded-lg p-4 mb-4">
                            <h5 className="text-sm font-medium text-blue-900 mb-2">可能的追问：</h5>
                            <ul className="text-sm text-blue-700 space-y-1">
                              {question.followUps.map((followUp, followIndex) => (
                                <li key={followIndex} className="flex items-start">
                        ...
                        <div className="bg-green-50 rounded-lg p-4">
                          <h5 className="text-sm font-medium text-green-900 mb-2">评估标准：</h5>
                          <ul className="text-sm text-green-700 space-y-1">
