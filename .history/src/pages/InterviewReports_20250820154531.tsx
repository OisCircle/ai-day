  ...
  const generateAIInsights = () => {
    ...
    candidatesData.forEach(candidate => {
      insights.set(candidate.id, {
        ...
        reasoning: 'AI综合分析显示该候选人技术能力强，学习能力突出，与团队文化高度匹配',
        skills: [
          { name: 'React', score: Math.round((Math.random() * 2 + 8) * 10) / 10 },
          { name: 'TypeScript', score: Math.round((Math.random() * 2 + 7) * 10) / 10 },
          { name: '系统设计', score: Math.round((Math.random() * 3 + 7) * 10) / 10 },
        ],
        personalityTraits: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="flex items-start p-3 bg-white bg-opacity-60 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">React和TypeScript技能的候选人表现优于其他技术栈15%</p>
            </div>
          </div>
          <div className="flex items-start p-3 bg-white bg-opacity-60 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">AI识别出3位高匹配度候选人，建议优先安排终面</p>
            </div>
          </div>
          <div className="flex items-start p-3 bg-white bg-opacity-60 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">优化面试流程，AI分析显示技术面试时长可缩短至40分钟</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500 mt-1">高级前端工程师 • 文化匹配 {aiInsight.culturalFit}%</p>
                  </div>
                </div>
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {aiInsight.skills.slice(0, 3).map((skill) => (
                    <div key={skill.name} className="bg-gray-50 p-2 rounded-lg text-center">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {aiInsight.personalityTraits.map((trait) => (
                    <div key={trait.trait} className="bg-green-50 px-2 py-1 rounded-full text-xs">
                      <span className="font-medium text-green-800">{trait.trait}</span>
                      <span className="text-green-600 ml-1">{trait.score}/100</span>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center">
                    <div className={`w-2 h-2 rounded-full mr-1 ${
                      aiInsight.riskLevel === 'low' ? 'bg-green-400' : 
                      aiInsight.riskLevel === 'medium' ? 'bg-yellow-400' : 'bg-red-400'
                    }`} />
                    {aiInsight.riskLevel === 'low' ? '低风险' : 
                     aiInsight.riskLevel === 'medium' ? '中风险' : '高风险'}
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600 mb-1">
                      {aiInsights.get(selectedCandidate.id)!.riskLevel === 'low' ? '低' :
                       aiInsights.get(selectedCandidate.id)!.riskLevel === 'medium' ? '中' : '高'}
                    </div>
                ...
                <div className="card p-6">
                  ...
                  <div className="space-y-4">
                    {aiInsights.get(selectedCandidate.id)!.personalityTraits.map((trait) => (
                      <div key={trait.trait} className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                        <div>
                          <span className="text-sm font-medium text-green-800">{trait.trait}</span>
                          <p className="text-xs text-green-600 mt-1">
                            AI评估：表现优异，与职位高度匹配
                          </p>
                        </div>
                        <div className="text-right">
                          <div className="text-lg font-bold text-green-600">{trait.score}</div>
