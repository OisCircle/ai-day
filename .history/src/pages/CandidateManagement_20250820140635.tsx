...
const CandidateManagement: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    ...
    const statusInfo = statusMap[status as keyof typeof statusMap] || { text: status, className: 'badge-gray' };
    return (
              ...
              <div className="lg:col-span-1">
                <div className="card p-4">
                  <div className="text-center mb-4">
                    ...
                    <h4 className="text-lg font-medium text-gray-900">{selectedCandidate.name}</h4>
                    <p className="text-sm text-gray-500">{getJobTitle(selectedCandidate.appliedPosition)}</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      申请时间: {new Date(selectedCandidate.createdAt).toLocaleDateString('zh-CN')}
                    </div>
                  </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="card p-4">
                  ...
                  <div className="space-y-2">
                    {['HR面试', '技术一面', '技术二面', 'VP面试'].map((stage, index) => {
                      const isCompleted = index < selectedCandidate.interviewRounds.length;
                      const isCurrent = index === selectedCandidate.interviewRounds.length;
                      return (
