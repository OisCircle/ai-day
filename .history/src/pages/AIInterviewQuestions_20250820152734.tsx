...
const AIInterviewQuestions: React.FC = () => {
  ...
  const [selectedInterviewType, setSelectedInterviewType] = useState<string>("hr");
  ...
  const currentQuestions = generateAIQuestions(selectedInterviewType, selectedCandidate);
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">候选人简历</h3>
                </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedCandidate.resume.skills.technical.map((skill, index) => (
                      <span
                        key={index}
                  ...
                  <div className="space-y-4">
                    {selectedCandidate.resume.experience.map((exp, index) => (
                      <div key={index} className="border-l-2 border-blue-200 pl-4 pb-4">
                        <div className="flex items-center justify-between">
                          <h6 className="font-medium text-gray-900">{exp.company}</h6>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {selectedCandidate.resume.projects.slice(0, 2).map((project, index) => (
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="absolute -top-1 -right-1">
                        <div className={`w-4 h-4 bg-${type.color}-500 rounded-full flex items-center justify-center`}>
            ...
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">{currentQuestions.title}</h3>
                    <p className="text-sm text-gray-600">AI智能生成的个性化面试题目</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
