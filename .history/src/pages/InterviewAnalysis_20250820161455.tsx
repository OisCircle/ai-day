    ...
    <div className="space-y-6">
      ...
      <div className="card p-6 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-xs bg-purple-100 text-purple-600 px-2 py-1 rounded-full">实时更新</span>
            <span className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded-full">AI驱动</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200">
            <h4 className="text-lg font-bold text-gray-900 mb-4">月度趋势图表</h4>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-start">
                ...
                <div>
                  <h5 className="font-bold text-gray-900 mb-1">候选人质量提升</h5>
                  <p className="text-sm text-gray-600">过去3个月候选人平均技术水平提升了18%，建议适当调整技术评估标准。</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-start">
                ...
                <div>
                  <h5 className="font-bold text-gray-900 mb-1">面试流程优化机会</h5>
                  <p className="text-sm text-gray-600">AI识别出技术二面环节存在15%的时间浪费，建议引入标准化流程。</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">基于当前趋势，下季度建议重点关注AI/ML技能候选人的招聘。</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl mb-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {analysisData.interviewerAiAnalysis.performanceMatrix
                  .filter(perf => perf.name === analysisData.interviewers.find(i => i.id === selectedInterviewer)?.name)
                  .map((perf, idx) => (
                  <div key={idx} className="text-center">
                    <div className="text-2xl font-bold text-blue-600 mb-1">{perf.technical}</div>
