    ...
    const allRounds = [
      {
        ...
        strengths: ["沟通表达能力强", "职业规划清晰", "学习意愿强烈", "团队协作意识好"],
        weaknesses: ["缺乏大厂工作经验", "对公司业务了解有限"],
        detailedFeedback: "候选人表现出良好的沟通能力和学习意愿，回答问题逻辑清晰，对职业规划有明确的想法。在团队协作方面有丰富的经验分享，展现了积极的工作态度。",
        aiAnalysis: "AI分析显示候选人在沟通能力和学习意愿方面表现突出，文化匹配度高达85%，建议进入下一轮技术面试。",
      },
      {
        ...
        strengths: ["React技术栈掌握扎实", "系统设计思路清晰", "代码质量高", "问题分析能力强"],
        weaknesses: ["部分新技术了解不够深入", "性能优化经验需要加强"],
        detailedFeedback: "候选人在技术面试中表现出色，对React生态系统有深入理解，能够清晰地解释复杂的技术概念。在系统设计题目中展现了良好的架构思维，代码实现规范。",
        aiAnalysis: "AI技能评估显示候选人React技能达到8.5/10，系统设计能力8.2/10，技术深度满足岗位要求，建议继续技术二面。",
      },
      {
        ...
        recommendation: "hire",
        aiScore: Math.round((Math.random() * 1.5 + 8) * 10) / 10,
        strengths: ["系统架构设计优秀", "性能优化思路清晰", "技术视野开阔", "解决复杂问题能力强"],
        weaknesses: ["微服务架构经验相对不足", "容器化部署了解有限"],
        detailedFeedback: "候选人在架构设计方面展现了很强的能力，能够从全局角度思考系统设计，对性能优化有深入理解。在讨论复杂业务场景时表现出色，技术深度符合高级工程师要求。",
        aiAnalysis: "AI深度评估显示候选人系统架构能力达到高级水平，问题解决能力突出，技术学习能力强，具备成长为技术专家的潜力。",
      },
      {
        ...
        strengths: ["战略思维清晰", "领导潜力突出", "业务理解深入", "沟通协调能力强"],
        weaknesses: ["管理经验有待加强", "行业洞察需要提升"],
        detailedFeedback: "候选人展现了优秀的战略思维和领导潜质，对技术发展趋势有清晰的认知，沟通表达能力强。在讨论团队建设和技术规划时见解独到，具备很强的成长潜力。",
        aiAnalysis: "AI综合评估显示候选人具备优秀的领导潜质和战略思维，团队协作能力95/100，推荐录用并纳入核心人才培养计划。",
      },
    ];
              ...
              <div className="grid grid-cols-4 gap-3 mb-6">
                ...
                <div className="text-center p-3 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                  <div className={`text-lg font-bold mb-1 ${
                    aiInsight.riskLevel === 'low' ? 'text-green-600' :
                    aiInsight.riskLevel === 'medium' ? 'text-yellow-600' : 'text-red-600'
                  }`}>
                    {aiInsight.riskLevel === 'low' ? '✅ 低' :
                     aiInsight.riskLevel === 'medium' ? '⚠️ 中' : '❌ 高'}
                  </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="text-sm font-bold text-gray-900 flex items-center">
                              {report.interviewType === "hr" ? "🤝 HR面试" :
                               report.interviewType === "tech_1" ? "💻 技术一面" :
                               report.interviewType === "tech_2" ? "🏗️ 技术二面" : "🎯 VP面试"}
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            面试官: {report.interviewerName} •
                            {new Date(report.date).toLocaleDateString("zh-CN")} •
                            {Math.round((new Date(report.date).getTime() - new Date("2024-01-15").getTime()) / (1000 * 60))}分钟
                          </p>
                        </div>
                      </div>
                                    ...
                                    <div className="text-sm">
                                      ...
                                      <p className="text-green-700 leading-relaxed mb-3">
                                        {trait.trait === '主动性' ? '候选人展现出强烈的工作主动性，能够主动承担责任，在团队中起到推动作用' :
                                         ...
                                         '该候选人在各项软技能方面表现良好，具备职业发展所需的基础素质'}
                                      </p>
