...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const processedCandidates = candidatesData.map(candidate => ({
      ...candidate,
      interviewRounds: candidate.interviewRounds.map(roundId => 
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              {aiInsights.map((insight) => {
                ...
                return (
                  <div key={insight.id} className={`border-l-4 p-4 rounded-r-lg ${getInsightColor(insight.priority)}`}>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-900">优秀候选人</p>
                    <p className="text-xs text-blue-700 mt-1">陈小明匹配度达92%</p>
                  </div>
                </div>
              </div>
              <div className="p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-900">最佳面试时间</p>
                    <p className="text-xs text-green-700 mt-1">建议安排在周二下午</p>
                  </div>
                </div>
              </div>
              <div className="p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm font-medium text-purple-900">问题优化</p>
                    <p className="text-xs text-purple-700 mt-1">建议增加行为类问题</p>
                  </div>
                </div>
              </div>
            </div>
