...
const InterviewAnalysis: React.FC = () => {
  ...
  const analysisData = {
    ...
    skills: [
      ...
      { skill: 'Node.js', avgScore: 7.1, difficulty: 'medium', trend: 'stable' },
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{analysisData.summary.totalInterviews}</p>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{analysisData.summary.averageScore}</p>
              <p className="text-sm text-green-600 flex items-center">
                <TrendingUp className="h-3 w-3 mr-1" />
                +0.3 vs 上月
              </p>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{analysisData.summary.passRate}%</p>
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{analysisData.summary.averageDuration}分钟</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* 面试类型分析 */}
        <div className="card p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">面试轮次分析</h3>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-gray-500">{type.count} 场</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium text-gray-900">{type.avgScore}</div>
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="text-xs text-gray-500">{interviewer.interviews} 场面试</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-900">{interviewer.avgScore}</div>
                  <div className="text-xs text-gray-500">平均分</div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-medium text-green-600">{interviewer.efficiency}%</div>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">技能</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">平均分数</th>
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">难度等级</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {analysisData.skills.map((skill, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center">
                      <span className="text-sm text-gray-900 mr-2">{skill.avgScore}</span>
                  ...
                  <td className="py-3 px-4">
                    <span className={`badge ${
                      skill.difficulty === 'high' ? 'badge-danger' :
                      skill.difficulty === 'medium' ? 'badge-warning' : 'badge-success'
                    }`}>
                      {skill.difficulty === 'high' ? '困难' :
                       skill.difficulty === 'medium' ? '中等' : '简单'}
                    </span>
                  </td>
                  <td className="py-3 px-4">
                    <div className="flex items-center">
